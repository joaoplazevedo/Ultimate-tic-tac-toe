...
public class JogoGaloGui {
  ...
  public static void main(String[] args) {
    ...
    chooseMode.setLayout(new BoxLayout(chooseMode, BoxLayout.Y_AXIS));

    JLabel modeLabel = new JLabel("Escolhe o modo de jogo:");
    modeLabel.setFont(new Font("Arial", Font.BOLD, 45));
    modeLabel.setAlignmentX(JPanel.CENTER_ALIGNMENT);

    JButton ai0 = new JButton("2 jogadores");
    ai0.setAlignmentX(JPanel.CENTER_ALIGNMENT);
    ai0.setFont(new Font("Arial", Font.PLAIN, 30));
    ai0.addActionListener(e -> {
      ai = 0;
      vaiCentro(chooseMode, centro);
    });

    JButton ai1 = new JButton("IA fácil");
    ai1.setAlignmentX(JPanel.CENTER_ALIGNMENT);
    ai1.setFont(new Font("Arial", Font.PLAIN, 30));
    ai1.addActionListener(e -> {
      ai = 1;
      vaiCentro(chooseMode, centro);
    });

    JButton ai2 = new JButton("IA difícil");
    ai2.setAlignmentX(JPanel.CENTER_ALIGNMENT);
    ai2.setAlignmentY(JPanel.CENTER_ALIGNMENT);
    ai2.setFont(new Font("Arial", Font.PLAIN, 30));
    ai2.addActionListener(e -> {
      ai = 2;
      vaiCentro(chooseMode, centro);
    });

    chooseMode.add(modeLabel);
    ...
    play.addActionListener(e -> vaiCentro(start, chooseMode));
